...
BEGIN_MESSAGE_MAP(CDialogBaseDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_EN_CHANGE(IDC_EDIT1, &CDialogBaseDlg::OnEnChangeEdit1)
...
void CDialogBaseDlg::OnEnChangeEdit1()
{
...
void CDialogBaseDlg::OnBnClickedStart()
{
	...
	for (int i = 0; i < m_num3; i++) {
		CString str;
		str.Format(_T("%02d"), m_num1 + rand() % (m_num2 - m_num1 + 1));
